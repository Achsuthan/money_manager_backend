...
/**
 * Servlet implementation class GetUserByTransactionIdGroup
 */
@WebServlet("/GetUserByTransactionIdGroup")
public class GetUserByTransactionIdGroup extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetUserByTransactionIdGroup() {
		super();
